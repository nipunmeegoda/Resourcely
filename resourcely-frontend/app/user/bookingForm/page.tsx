  ...
  return (
    <div className="bg-blue-100 lg:h-screen lg:overflow-hidden py-4 lg:py-2 px-4">
      <div className="max-w-4xl mx-auto lg:h-full lg:flex lg:flex-col">
        ...
        {/* Main Form Container */}
        <Card className="bg-yellow-100 shadow-lg overflow-hidden flex-shrink lg:flex-1">
          <CardContent className="p-6 lg:p-4 h-full">
                ...
                <div className="lg:col-span-3 space-y-1">
                  ...
                  <div className="form-group mt-4">
                    ...
                    <Textarea
                      ...
                      rows={4}
                      className={`max-w-md resize-none lg:text-base text-lg ${
                ...
                <div className="lg:col-span-2 space-y-1">
                  ...
                  <div className="form-group mt-1">
                    ...
                    <Input
                      ...
                      className={`max-w-md lg:text-base text-lg ${
              ...
              <div className="mt-6 lg:mt-4 pt-6 border-t-2 border-sky-200 flex flex-col items-center gap-4">
                <div className="flex gap-4">
                  <Button
                    ...
                    className="bg-sky-500 hover:bg-sky-600 text-white font-bold py-3 px-8 text-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
                  >
                  ...
                  <Button
                    ...
                    className="bg-white hover:bg-sky-50 text-sky-600 font-bold py-3 px-8 border-2 border-sky-500 hover:border-sky-600 text-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
                  >
                    Back to Rooms
                  </Button>
                </div>
                <div className="text-center">
                  <p className="text-sm text-gray-600 bg-sky-50 px-4 py-2 rounded-lg border border-sky-200">
                    📧 You will receive a confirmation email once your request
                    is approved
                  </p>
                </div>
              </div>
