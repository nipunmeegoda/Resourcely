...
// Normalize role and persist
            ...
            localStorage.setItem(
                "auth",
                JSON.stringify({ isAuthenticated: true, user: { ...serverData.user, role } })
            );
...
// Navigate (SPA) + hard fallback
            queueMicrotask(() => navigate(nextPath, { replace: true }));
            setTimeout(() => {
                ...
                >
                    ...
                    <Box component="form" onSubmit={handleSubmit} noValidate sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                        <FormControl fullWidth>
                            <FormLabel
                                htmlFor="email"
                                sx={{ color: "white", fontSize: "0.9375rem", mb: 0.5, fontWeight: 500 }}
                            >
                                Email
                            </FormLabel>
                            <TextField
                                ...
                                fullWidth
                                sx={{
                                    "& .MuiInputBase-input": { color: "white", fontSize: "0.9375rem", py: 1.5 },
                        ...
                        <FormControl fullWidth>
                            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 0.5 }}>
                                <FormLabel
                                    htmlFor="password"
                                    sx={{ color: "white", fontSize: "0.9375rem", m: 0, fontWeight: 500 }}
                                >
                                    Password
                                </FormLabel>
                                <Link
                        ...
                        <Button
                            ...
                            fullWidth
                            variant="contained"
                            sx={{ backgroundColor: " #f00b0bb9", color: "#fff", "&:hover": { backgroundColor: "#ff0000ff" } }}
                        >
                            Sign in
                        </Button>
