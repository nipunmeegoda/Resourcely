...
// ✅ Sitemark Icon (SVG)
export const SitemarkIcon: React.FC = (): JSX.Element => {
  return (
    <SvgIcon sx={{ height: 21, width: 100, mr: 2 }}>
      ...
      >
        ...
        <path fill="#4876EE" d="M32.507 8.804v6.167h2.312v-7.86h-3.366v1.693h1.054Z"/>
        {/* Other paths truncated for brevity */}
      </svg>
    </SvgIcon>
  );
};
...
// ✅ Facebook Icon
export const FacebookIcon: React.FC = (): JSX.Element => {
  return (
    <SvgIcon>
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M11.12 10.2391L11.48 7.99914H9.36V6.43914C9.36 5.79914 9.6 5.31914 10.56 5.31914H11.6V3.27914C11.04 3.19914 10.4 3.11914 9.84 3.11914C8 3.11914 6.72 4.23914 6.72 6.23914V7.99914H4.72V10.2391H6.72V15.8791C7.16 15.9591 7.6 15.9991 8.04 15.9991C8.48 15.9991 8.92 15.9591 9.36 15.8791V10.2391H11.12Z" fill="white"/>
        <defs>
...
// ✅ Google Icon
export const GoogleIcon: React.FC = (): JSX.Element => {
  return (
    <SvgIcon>
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
