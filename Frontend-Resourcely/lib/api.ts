...
const mockBookings: Booking[] = [
  {
    ...
    organizer: { id: 'u1', name: 'Dr. Sarah Johnson', email: 'sarah.j@university.edu' },
  ...
  },
  {
    ...
    organizer: { id: 'u2', name: 'Prof. Michael Chen', email: 'michael.c@university.edu' },
  ...
  },
  {
    ...
    organizer: { id: 'u3', name: 'Dr. Emily Rodriguez', email: 'emily.r@university.edu' },
  ...
  },
  {
    ...
    hallId: 'h1',
    hallName: 'Main Auditorium',
    organizer: { id: 'u4', name: 'Prof. James Wilson', email: 'james.w@university.edu' },
  ...
  },
  {
    ...
    organizer: { id: 'u5', name: 'Dr. Anna Martinez', email: 'anna.m@university.edu' },
...
const mockHalls: Hall[] = [
  { id: 'h1', name: 'Main Auditorium', capacity: 200, location: 'Building A, Floor 1' },
  { id: 'h2', name: 'Computer Lab 1', capacity: 50, location: 'Building B, Floor 2' },
  { id: 'h3', name: 'Seminar Room A', capacity: 80, location: 'Building A, Floor 2' },
  { id: 'h4', name: 'Conference Hall', capacity: 100, location: 'Building C, Floor 1' },
];
